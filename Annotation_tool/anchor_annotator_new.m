...
function varargout = anchor_annotator_new(varargin)
...
% Last Modified by GUIDE v2.5 24-Nov-2016 10:43:30
...
%offset = (principal_point - imgsize/2)/(M*f);
...
data_mask = load(fullfile(PathName, FileName));
